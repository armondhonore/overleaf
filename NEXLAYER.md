...
**Live:** [https://relaxed-weasel-overleaf.cloud.nexlayer.ai](https://relaxed-weasel-overleaf.cloud.nexlayer.ai)  
...
**overleaf** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/sharelatex/sharelatex:5
    path: /
    servicePorts:
    - 80
    vars:
      OVERLEAF_REDIS_HOST: overleaf-redis.pod
      OVERLEAF_MONGO_URL: "mongodb://overleaf-mongo.pod:27017/sharelatex?directConnection=true"
    ...
    - name: overleaf-data
      ...
      size: 10Gi
  - name: overleaf-mongo
    image: mirror.gcr.io/bitnami/mongodb:latest
    servicePorts:
    - 27017
    vars:
      MONGODB_REPLICA_SET_MODE: primary
      MONGODB_REPLICA_SET_NAME: rs0
      MONGODB_ADVERTISED_HOSTNAME: overleaf-overleaf-mongo-service.relaxed-weasel.svc.cluster.local
      MONGODB_PRIMARY_HOST: overleaf-overleaf-mongo-service.relaxed-weasel.svc.cluster.local
